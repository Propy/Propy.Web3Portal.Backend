const { ERC721_TOKEN_URI_UPDATE_EVENT_TABLE, NETWORK_TABLE, EVM_TRANSACTION_TABLE } = require("../tables");

exports.up = (knex) => knex.schema.createTable(ERC721_TOKEN_URI_UPDATE_EVENT_TABLE, table => {
    table.increments();
    ...
    table.string("token_state").notNullable();
...
exports.down = knex => knex.schema.dropTable(ERC721_TOKEN_URI_UPDATE_EVENT_TABLE);