const { BASE_WITHDRAWAL_FINALIZED_EVENT_TABLE, EVM_TRANSACTION_TABLE, NETWORK_TABLE } = require("../tables");

exports.up = (knex) => knex.schema.createTable(BASE_WITHDRAWAL_FINALIZED_EVENT_TABLE, table => {
  table.increments();
  ...
  table.boolean("success").index().notNullable();
...
exports.down = knex => knex.schema.dropTable(BASE_WITHDRAWAL_FINALIZED_EVENT_TABLE);