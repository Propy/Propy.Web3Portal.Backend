const { STAKING_CONTRACT_TABLE, NETWORK_TABLE } = require("../tables");

exports.up = (knex) => knex.schema.createTable(STAKING_CONTRACT_TABLE, table => {
  table.increments();
...
exports.down = knex => knex.schema.dropTable(STAKING_CONTRACT_TABLE);