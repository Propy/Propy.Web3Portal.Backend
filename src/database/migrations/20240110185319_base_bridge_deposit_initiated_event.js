const { BASE_DEPOSIT_BRIDGE_INITIATED_EVENT_TABLE, EVM_TRANSACTION_TABLE, NETWORK_TABLE } = require("../tables");

exports.up = (knex) => knex.schema.createTable(BASE_DEPOSIT_BRIDGE_INITIATED_EVENT_TABLE, table => {
  table.increments();
...
exports.down = knex => knex.schema.dropTable(BASE_DEPOSIT_BRIDGE_INITIATED_EVENT_TABLE);